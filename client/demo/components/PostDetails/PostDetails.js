        ...
        <div className="card">
            <div className="flex justify-content-between flex-column-reverse md:flex-row align-items-center">
                ...
                <span className="inline-flex align-items-center py-2 px-3 font-medium border-1 surface-border border-round">
                    ...
                    <span className="text-900" onClick={() => openInNewTab(`https://wa.me/593${post.cellphone}?text=Hola, acabo de ver tu anuncio en K0K4, "${post.title.substring(0, 25)}(…)", y me gustaría quedar contigo.`)}>WhatsApp</span>
                </span>
                    </div>
                </div>
