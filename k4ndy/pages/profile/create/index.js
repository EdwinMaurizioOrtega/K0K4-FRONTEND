                ...
                <div className="col-12 lg:col-10">
                    <div className="grid formgrid p-fluid">
                        ...
                        <div className="field mb-4 col-12">
                            ...
                            <FileUpload mode="basic" name="avatar" url="./upload.php" accept="image/*" maxFileSize={1000000} chooseOptions={{ label: 'Uplaod Image', className: 'p-button-outlined p-button-plain' }}></FileUpload>
                        </div>
                        <div className="field mb-4 col-12">
