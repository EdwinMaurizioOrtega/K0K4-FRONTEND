...
const TimelineDemo = () => {
    const customEvents = [
        ...
        { status: 'Processing', date: '15/09/2022 14:00', icon: 'pi pi-cog', color: '#673AB7' },
        { status: 'Shipped', date: '15/09/2022 16:15', icon: 'pi pi-envelope', color: '#FF9800' },
        { status: 'Delivered', date: '16/09/2022 10:00', icon: 'pi pi-check', color: '#607D8B' }
    ];
