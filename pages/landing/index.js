        ...
        <div className="relative overflow-hidden flex flex-column justify-content-center">
            ...
            <div className="landing-wrapper">
                <div className="flex align-items-center justify-content-between relative lg:static py-6 px-4 mx-0 md:px-7 lg:px-8 lg:py-6 lg:mx-8">
                    ...
                    <div className={classNames('align-items-center flex-grow-1 hidden md:flex absolute md:static w-full md:px-0 z-3 shadow-2 md:shadow-none fadein', { hidden: isHidden })} style={{ top: '80px', right: '0%' }}>
                        <ul className="list-none p-3 md:p-0 m-0 ml-auto flex md:align-items-center select-none flex-column md:flex-row cursor-pointer surface-card md:surface-ground">
                            ...
                            <li>
                                <a href="#apps" onClick={toggleMenuItemClick} className="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                    <span>Apps</span>
                                    <Ripple />
                                </a>
                            </li>
                ...
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 z-2">
                    <div id="home" className="grid grid-nogutter justify-content-between align-items-center mb-6 py-6 md:mb-8 md:py-8">
                        ...
                        <div className="col-12 md:col-7 flex-order-0 md:flex-order-1 mb-6 md:mb-0 border-round">
                            <img src={`/demo/images/landing/${darkMode ? 'dashboard-dark' : 'dashboard-light'}.png`} alt="" className="w-full h-full border-round shadow-2 animation-duration-1000 fadeinright" />
                        </div>
                    </div>
                    ...
                    <div id="apps" className="my-6 md:my-8">
                        ...
                        <div className="flex flex-column lg:flex-row align-items-center justify-content-between mt-8 gap-8">
                            <div className="flex flex-column align-items-center">
                                <img src={`/demo/images/landing/${darkMode ? 'chat-dark' : 'chat-light'}.png`} alt="chat" className="w-full h-full border-round surface-border shadow-2 animation-duration-500 scalein origin-top" />
                                <span className="block text-900 text-lg font-semibold mt-4">Chat</span>
                            </div>
                            <div className="flex flex-column align-items-center">
                                <img src={`/demo/images/landing/${darkMode ? 'mail-dark' : 'mail-light'}.png`} alt="chat" className="w-full h-full border-round surface-border shadow-2 animation-duration-500 scalein origin-top" />
                                <span className="block text-900 text-lg font-semibold mt-4">Mail</span>
                            </div>
                            <div className="flex flex-column align-items-center">
                                <img src={`/demo/images/landing/${darkMode ? 'kanban-dark' : 'kanban-light'}.png`} alt="chat" className="w-full h-full border-round surface-border shadow-2 animation-duration-500 scalein origin-top" />
                        ...
                        <div className="grid mt-8">
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src="/demo/images/landing/icon-components.svg" alt="components icon" className="block mb-3" />
                            ...
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src="/demo/images/landing/icon-community.svg" alt="components icon" className="block mb-3" />
                            ...
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src="/demo/images/landing/icon-productivity.svg" alt="components icon" className="block mb-3" />
                            ...
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src="/demo/images/landing/icon-accessibility.svg" alt="components icon" className="block mb-3" />
                            ...
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src="/demo/images/landing/icon-support.svg" alt="components icon" className="block mb-3" />
                            ...
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src="/demo/images/landing/icon-mobile.svg" alt="components icon" className="block mb-3" />
                            ...
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src="/demo/images/landing/icon-theme.svg" alt="components icon" className="block mb-3" />
                            ...
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src="/demo/images/landing/icon-ts.svg" alt="components icon" className="block mb-3" />
