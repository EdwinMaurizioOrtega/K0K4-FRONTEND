...
`<div className="bg-blue-500></div>`
                                ...
                                {shades.map((shade, j) => {
                                    return (
                                        <React.Fragment key={shade + j}>
                                            {shade !== 0 && (
                                                <div className="flex align-items-center w-19rem p-3 font-bold" style={{ backgroundColor: 'var(--' + color + '-' + shade, color: shade > 500 ? '#fff' : '#000' }}>
                                                    {color}-{shade}
                                                </div>
                                            )}
                                        </React.Fragment>
            ...
            <div className="card">
                <div className="flex flex-column">
                    {shades.map((shade, i) => {
                        return (
                            <div key={i + shade} className="flex align-items-center w-19rem p-3 font-bold" style={{ backgroundColor: 'var(--surface-' + shade, color: dark ? (shade > 400 ? '#000' : '#fff') : shade > 500 ? '#fff' : '#000' }}>
                                surface-{shade}
                            </div>
                        );
                    })}
