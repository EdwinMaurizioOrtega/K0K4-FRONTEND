                    ...
                    <div className="grid formgrid">
                        <div className="col-12 field mb-6">
                            ...
                            <div className="field-checkbox">
                                <Checkbox name="checkbox-1" onChange={(e) => setChecked(e.checked)} checked={checked} inputId="checkbox-1"></Checkbox>
                        ...
                        <div className="col-12 lg:col-6 field mb-4">
                            <div className="field-checkbox">
                                <Checkbox name="checkbox-2" onChange={(e) => setChecked2(e.checked)} checked={checked2} inputId="checkbox-2"></Checkbox>
