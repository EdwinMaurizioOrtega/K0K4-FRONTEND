...
function BlogList() {
    ...
    const dataViewHeader = (
        <div className="flex flex-column sm:flex-row sm:align-items-center sm:justify-content-between gap-3">
            ...
            <Dropdown value={sortKey} options={sortOptions} optionLabel="label" placeholder="Sort By" onChange={onSortChange} className="w-full md:w-15rem" />
        </div>
    );
    ...
    return (
        <React.Fragment>
            <div className="card">
                <DataView value={totalBlogs} paginator rows={3} layout={'grid'} sortOrder={sortOrder} sortField={sortField} itemTemplate={itemTemplate} header={dataViewHeader}></DataView>
            </div>
