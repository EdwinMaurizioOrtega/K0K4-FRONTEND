                ...
                <div className="flex align-items-center justify-content-between relative lg:static py-6 px-4 mx-0 md:px-7 lg:px-8 lg:py-6 lg:mx-8">
                    ...
                    <div className="align-items-center flex-grow-1 hidden md:flex absolute md:static w-full md:px-0 z-3 shadow-2 md:shadow-none fadein" style={{ top: '80px', right: '0%' }}>
                        <ul className="list-none p-3 md:p-0 m-0 ml-auto flex md:align-items-center select-none flex-column md:flex-row cursor-pointer surface-card md:surface-ground">
                            <li>
                                <a href="#home" className="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                    <span>Home</span>
                                </a>
                                <Ripple />
                            </li>
                            <li>
                                <a href="#apps" className="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                    <span>Apps</span>
                                </a>
                                <Ripple />
                            </li>
                            <li>
                                <a href="#features" className="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                    <span>Features</span>
                                </a>
                                <Ripple />
                            </li>
                            <li>
                                <a href="/auth/login" className="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                    <span>Login</span>
                                </a>
                                <Ripple />
                            </li>
                            <li>
                                <Button type="button" label="Buy Now" className="m-0 mt-3 md:mt-0 md:ml-5"></Button>
                            </li>
                        </ul>
                    </div>
                </div>
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 z-2">
                    <div id="home" className="grid grid-nogutter justify-content-between align-items-center mb-6 py-6 md:mb-8 md:py-8">
                        <div className="col-12 md:col-4 flex flex-column gap-4 flex-order-1 md:flex-order-0 align-items-center md:align-items-start text-center md:text-left">
                            <span className="block text-900 font-bold text-4xl">Modern, stylish and clean</span>
                            <span className="block text-700 text-lg">The ultimate collection of design-agnostic, flexible and accessible UI Components.</span>
                            <ul className="flex flex-wrap gap-5 list-none p-0">
                                <li className="flex align-items-center">
                                    <div className="p-1 border-circle bg-green-400 inline-block mr-2"></div>
                                    <span className="text-900 font-semibold">Javascript</span>
                                </li>
                                <li className="flex align-items-center">
                                    <div className="p-1 border-circle bg-green-400 inline-block mr-2"></div>
                                    <span className="text-900 font-semibold">TypeScript</span>
                                </li>
                                <li className="flex align-items-center">
                                    <div className="p-1 border-circle bg-green-400 inline-block mr-2"></div>
                                    <span className="text-900 font-semibold">React</span>
                                </li>
                            </ul>
                            <Button type="button" label="Live Preview" icon="pi pi-arrow-right" iconPos="right" className="w-12rem p-button-outlined"></Button>
                        </div>

                        <div className="col-12 md:col-7 flex-order-0 md:flex-order-1 mb-6 md:mb-0 border-round">
                            <img src={`${contextPath}/demo/images/landing/${darkMode ? 'dashboard-dark' : 'dashboard-light'}.png`} alt="" className="w-full h-full border-round shadow-2 animation-duration-1000 fadeinright" />
                        </div>
                    </div>

                    <div id="apps" className="my-6 md:my-8">
                        <span className="text-900 block font-bold text-5xl mb-4 text-center">Apps</span>
                        <span className="text-700 block text-xl mb-8 text-center line-height-3">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit numquam eligendi quos.</span>

                        <div className="flex flex-column lg:flex-row align-items-center justify-content-between mt-8 gap-8">
                            <div className="flex flex-column align-items-center">
                                <img src={`${contextPath}/demo/images/landing/${darkMode ? 'chat-dark' : 'chat-light'}.png`} alt="chat" className="w-full h-full border-round surface-border shadow-2 animation-duration-500 scalein origin-top" />
                                <span className="block text-900 text-lg font-semibold mt-4">Chat</span>
                            </div>
                            <div className="flex flex-column align-items-center">
                                <img src={`${contextPath}/demo/images/landing/${darkMode ? 'mail-dark' : 'mail-light'}.png`} alt="chat" className="w-full h-full border-round surface-border shadow-2 animation-duration-500 scalein origin-top" />
                                <span className="block text-900 text-lg font-semibold mt-4">Mail</span>
                            </div>
                            <div className="flex flex-column align-items-center">
                                <img src={`${contextPath}/demo/images/landing/${darkMode ? 'kanban-dark' : 'kanban-light'}.png`} alt="chat" className="w-full h-full border-round surface-border shadow-2 animation-duration-500 scalein origin-top" />
                                <span className="block text-900 text-lg font-semibold mt-4">Kanban</span>
                            </div>
                        </div>
                    </div>

                    <div id="features" className="my-6 py-6 md:my-8 md:py-8">
                        <span className="text-900 block font-bold text-5xl mb-4 text-center">Features</span>
                        <span className="text-700 block text-xl mb-8 text-center line-height-3">
                            PrimeTek Informatics is the author of PrimeReact, a UI Component vendor with well known vastly popular projects including PrimeFaces, PrimeNG and PrimeVue.
                        </span>
                        ...
                        <div className="grid mt-8">
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src={`${contextPath}/demo/images/landing/icon-components.svg`} alt="components icon" className="block mb-3" />
                                    <span className="text-900 block font-semibold mb-3 text-lg">90+ UI Components</span>
                                    <p className="m-0 text-secondary text-700">The ultimate set of UI Components to assist you with 90+ impressive React Components.</p>
                                </div>
                            </div>
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src={`${contextPath}/demo/images/landing/icon-community.svg`} alt="components icon" className="block mb-3" />
                                    <span className="text-900 block font-semibold mb-3 text-lg">Community</span>
                                    <p className="m-0 text-secondary text-700">Connect with the other open source community members, collaborate and have a voice in the project roadmap.</p>
                                </div>
                            </div>
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src={`${contextPath}/demo/images/landing/icon-productivity.svg`} alt="components icon" className="block mb-3" />
                                    <span className="text-900 block font-semibold mb-3 text-lg">Productivity</span>
                                    <p className="m-0 text-secondary text-700">Boost your productivity by achieving more in less time and accomplish amazing results.</p>
                                </div>
                            </div>
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src={`${contextPath}/demo/images/landing/icon-accessibility.svg`} alt="components icon" className="block mb-3" />
                                    <span className="text-900 block font-semibold mb-3 text-lg">Accessibility</span>
                                    <p className="m-0 text-secondary text-700">The ultimate set of UI Components to assist you with 90+ impressive React Components.</p>
                                </div>
                            </div>
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src={`${contextPath}/demo/images/landing/icon-support.svg`} alt="components icon" className="block mb-3" />
                                    <span className="text-900 block font-semibold mb-3 text-lg">Enterprise Support</span>
                                    <p className="m-0 text-secondary text-700">Exceptional support service featuring response within 1 business day and option to request enhancements and new features for the library.</p>
                                </div>
                            </div>
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src={`${contextPath}/demo/images/landing/icon-mobile.svg`} alt="components icon" className="block mb-3" />
                                    <span className="text-900 block font-semibold mb-3 text-lg">Mobile</span>
                                    <p className="m-0 text-secondary text-700">First class support for responsive design led by touch optimized elements.</p>
                                </div>
                            </div>
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src={`${contextPath}/demo/images/landing/icon-theme.svg`} alt="components icon" className="block mb-3" />
                                    <span className="text-900 block font-semibold mb-3 text-lg">Themes</span>
                                    <p className="m-0 text-secondary text-700">Built on a design-agnostic api, choose from a vast amount of themes such as material, bootstrap, custom or develop your own.</p>
                                </div>
                            </div>
                            <div className="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                                <div className="box p-4 w-full surface-card surface-border border-1 border-round">
                                    <img src={`${contextPath}/demo/images/landing/icon-ts.svg`} alt="components icon" className="block mb-3" />
                                    <span className="text-900 block font-semibold mb-3 text-lg">Typescript</span>
                                    <p className="m-0 text-secondary text-700">Top-notch support for Typescript with types and tooling assistance.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="pricing" className="my-6 py-6 md:my-8 md:py-8">
                        <div className="text-900 font-bold text-5xl mb-4 text-center">Pricing Plans</div>
                        <div className="text-700 text-xl mb-8 text-center line-height-3">Choose a plan that works best for you and your team.</div>

                        <div className="grid grid-nogutter justify-content-center mt-8">
                            <div className="col-12 lg:col-6 xl:col-4">
                                <div className="p-3 h-full">
                                    <div className="shadow-2 p-6 h-full flex flex-column surface-card" style={{ borderRadius: '6px' }}>
                                        <span className="text-900 block font-medium text-xl mb-2 text-center">Basic Licence</span>
                                        <span className="font-bold block text-2xl text-900 text-center">$29</span>
                                        ...
                                        <Button label="Choose Plan" className="px-5 w-full mt-6 p-button-outlined" icon="pi pi-arrow-right" iconPos="right"></Button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-12 lg:col-6 xl:col-4">
                                <div className="p-3 h-full">
                                    <div className="shadow-2 p-6 h-full flex flex-column surface-card" style={{ borderRadius: '6px' }}>
                                        <span className="text-900 block font-medium text-xl mb-2 text-center">Extended Licence</span>
                                        <span className="font-bold block text-2xl text-900 text-center">$49</span>
